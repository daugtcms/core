<div @class(["relative w-full", "h-[36rem]" => !empty($personImage), "h-96 sm:h-[36rem]" => empty($personImage)])>
    ...
    <div class="container mx-auto px-4 h-full">
        <div class="relative sm:overflow-hidden h-full flex flex-col sm:flex-row items-center justify-between pt-28 sm:pt-0 min-h-0 ">
            <div class="relative flex items-start justify-center flex-col sm:mt-12 pl-4 flex-grow min-h-0">
                ...
                <p class="mt-6 max-w-lg text-xl md:text-2xl text-secondary-50 text-left line-clamp-4">
