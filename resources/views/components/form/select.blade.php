...
"
     ...
     @keydown.enter="if(selectOpen){ selectedItem=selectableItemActive; selectOpen=false; }"
    ...
    <button type="button" x-modelable="selectedItem.value" x-ref="selectButton"
        ...
        <span x-text="selectedItem ? (selectedItem.title ?? selectedItem.value) : '{{ __('site-core::general.no_value_available') }}'"
              :class="{ 'truncate pr-7': true, 'text-neutral-500': !selectedItem }">{{ __('site-core::general.no_value_available') }}</span>
    ...
    <ul
        ...
        <template x-for="item in selectableItems" :key="item.value">
            <li
                    @click="$refs.panel.toggle; selectedItem=item; selectOpen=false; $refs.selectButton.focus();"
