<label  class="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-200 focus:ring-offset-2" role="switch">
    <input type="checkbox" {{$attributes}} class="peer hidden">
