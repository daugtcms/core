<div class="container" wire:poll.10s>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-x-3 gap-y-3 mt-4 sm:mt-8">
        ...
        <div class="col-span-2 row-span-2 rounded-lg bg-white/75 backdrop-blur-md shadow flex flex-col overflow-hidden">
            ...
            <a class="bg-neutral-100/50 w-full px-3 py-1.5 flex items-center focus:outline-none justify-between hover:bg-white/50 border-t border-neutral-200" href="{{route('member-area.orders.index')}}">Alle Bestellungen ansehen @svg('arrow-right', 'w-5 h-5')</a>
        </div>
