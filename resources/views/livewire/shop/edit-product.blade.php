<form class="p-3" wire:submit="save">
    <x-daugt::modal.header>{{__('daugt::shop.manage_product')}}</x-daugt::modal.header>
    <div class="flex flex-col gap-y-2">
        ...
        <div>
            @php
                $categories = \Daugt\Models\Listing\Listing::where('usage', \Daugt\Enums\Listing\ListingUsage::SHOP_CATEGORIES)->first()->items
